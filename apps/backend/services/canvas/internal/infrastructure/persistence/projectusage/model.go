...
type providerCallRow struct {
	...
	RequestID        *string   `gorm:"size:191;uniqueIndex:idx_task_run_provider_calls_request"`
...
func (providerCallRow) TableName() string { return "task_run_provider_calls" }
...
func Models() []any { return []any{&providerCallRow{}, &usageRecordRow{}} }
