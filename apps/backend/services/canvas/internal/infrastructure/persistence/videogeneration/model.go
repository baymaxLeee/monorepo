...
type canvasnodeVideoGenerationRow struct {
	...
	FirstFrameCheckpointAssetID    *string `gorm:"size:64"`
	FirstFrameCheckpointRevisionID *string `gorm:"size:64"`
	LastFrameCheckpointAssetID     *string `gorm:"size:64"`
	LastFrameCheckpointRevisionID  *string `gorm:"size:64"`
