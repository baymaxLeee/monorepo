...
type taskRunRow struct {
	...
	TenantID     string             `gorm:"size:64;not null;index:idx_task_runs_subject,priority:1;index:idx_task_runs_creator_updated,priority:1"`
	WorkspaceID  *string            `gorm:"size:64;index:idx_task_runs_subject,priority:2;index:idx_task_runs_creator_updated,priority:2"`
