...
type CanvasNodeVideoProviderIdentity struct{ TenantID, CallerID, WorkspaceID, ProjectID string }
...
type GenerationStore interface {
	...
	ListFirstLastFrameCandidates(context.Context, Scope, []string) ([]domainvideo.Generation, error)
...
type FrameTaskRegistrationFailureReporter interface {
	ReportFrameTaskRegistrationFailure(context.Context, string, []string, error)
}
