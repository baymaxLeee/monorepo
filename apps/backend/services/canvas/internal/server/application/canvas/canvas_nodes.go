...
type CanvasNodeService struct {
	...
	frameEnsurer        SelectedOutputFirstLastFrameEnsurer
...
func WithSelectedOutputFirstLastFrameEnsurer(ensurer SelectedOutputFirstLastFrameEnsurer) CanvasNodeOption {
	return func(service *CanvasNodeService) {
		service.frameEnsurer = ensurer
	}
}
