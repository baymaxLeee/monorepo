...
func (h *ResourceHandler) ListResources(ctx context.Context, request *thriftresource.ListResourcesRequest) (*thriftresource.ListResourcesResponse, error) {
	...
	return &thriftresource.ListResourcesResponse{Items: dtos, Page: pageOutput(request.Page.PageSize, request.Page.PageNum, total)}, nil
}

func (h *ResourceHandler) GetProjectResourceStats(ctx context.Context, request *thriftresource.GetProjectResourceStatsRequest) (*thriftresource.GetProjectResourceStatsResponse, error) {
	...
	return &thriftresource.GetProjectResourceStatsResponse{
		Stats: &thriftresource.ProjectResourceStats{
...
func (h *ResourceHandler) GetResource(ctx context.Context, request *thriftresource.GetResourceRequest) (*thriftresource.GetResourceResponse, error) {
	...
	return &thriftresource.GetResourceResponse{Resource: dto}, err
}

func (h *ResourceHandler) BatchGetResources(ctx context.Context, request *thriftresource.BatchGetResourcesRequest) (*thriftresource.BatchGetResourcesResponse, error) {
	...
	dtos, err := h.resourceDTOs(ctx, scope, request.ProjectID, items)
	return &thriftresource.BatchGetResourcesResponse{Items: dtos}, err
}

func (h *ResourceHandler) CreateResource(ctx context.Context, request *thriftresource.CreateResourceRequest) (*thriftresource.CreateResourceResponse, error) {
	...
	return &thriftresource.CreateResourceResponse{
		Resource:       dto,
		ResourceAssets: resourceAssetDTOs(result.ResourceAssets, result.Resource.PrimaryResourceAssetID, assets),
	}, nil
}

func (h *ResourceHandler) CreateResourceFromAsset(ctx context.Context, request *thriftresource.CreateResourceFromAssetRequest) (*thriftresource.CreateResourceFromAssetResponse, error) {
	...
	response := &thriftresource.CreateResourceFromAssetResponse{
	...
	if result.CanvasNodeBinding != nil {
		response.CanvasNodeBinding = &thriftresource.CanvasNodeResourceAssetBinding{
...
func (h *ResourceHandler) UpdateResource(ctx context.Context, request *thriftresource.UpdateResourceRequest) (*thriftresource.UpdateResourceResponse, error) {
	...
	dto, err := h.resourceDTO(ctx, scope, request.ProjectID, item)
	return &thriftresource.UpdateResourceResponse{Resource: dto}, err
}

func (h *ResourceHandler) DeleteResource(ctx context.Context, request *thriftresource.DeleteResourceRequest) (*thriftbase.Empty, error) {
...
func (h *ResourceHandler) BatchDeleteResources(ctx context.Context, request *thriftresource.BatchDeleteResourcesRequest) (*thriftbase.Empty, error) {
...
func (h *ResourceHandler) ListResourceAssets(ctx context.Context, request *thriftresource.ListResourceAssetsRequest) (*thriftresource.ListResourceAssetsResponse, error) {
	...
	return &thriftresource.ListResourceAssetsResponse{Items: dtos, Page: pageOutput(request.Page.PageSize, request.Page.PageNum, total)}, nil
}

func (h *ResourceHandler) BatchGetResourceAssetGenerationStates(ctx context.Context, request *thriftresource.BatchGetResourceAssetGenerationStatesRequest) (*thriftresource.BatchGetResourceAssetGenerationStatesResponse, error) {
	...
	items := make([]*thriftresource.ResourceAssetGenerationState, 0, len(states))
	for _, state := range states {
		items = append(items, resourceAssetGenerationStateDTO(state))
	}
	return &thriftresource.BatchGetResourceAssetGenerationStatesResponse{Items: items}, nil
}

func (h *ResourceHandler) attachGenerationStates(ctx context.Context, target applicationresourceassetgeneration.Target, assets []domainresource.ResourceAsset, dtos []*thriftresource.ResourceAsset) error {
	...
	byID := make(map[string]*thriftresource.ResourceAssetGenerationState, len(states))
	for _, state := range states {
...
func (h *ResourceHandler) BatchListResourceAssets(ctx context.Context, request *thriftresource.BatchListResourceAssetsRequest) (*thriftresource.BatchListResourceAssetsResponse, error) {
	...
	responseGroups := make([]*thriftresource.ResourceAssetGroup, 0, len(groups))
	for _, group := range groups {
		responseGroups = append(responseGroups, &thriftresource.ResourceAssetGroup{
			ResourceID: group.Resource.ID,
			Items:      resourceAssetDTOs(group.Items, group.Resource.PrimaryResourceAssetID, assets),
		})
	}
	return &thriftresource.BatchListResourceAssetsResponse{Groups: responseGroups}, nil
}

func (h *ResourceHandler) CreateResourceAsset(ctx context.Context, request *thriftresource.CreateResourceAssetRequest) (*thriftresource.CreateResourceAssetResponse, error) {
	...
	return &thriftresource.CreateResourceAssetResponse{ResourceAsset: resourceAssetDTO(item, isPrimaryResourceAsset(parent, item.ID), assetItem)}, nil
}

func (h *ResourceHandler) CreateGeneratedResourceAsset(ctx context.Context, request *thriftresource.CreateGeneratedResourceAssetRequest) (*thriftresource.CreateGeneratedResourceAssetResponse, error) {
	...
	return &thriftresource.CreateGeneratedResourceAssetResponse{ResourceAsset: resourceAssetDTO(item, isPrimaryResourceAsset(parent, item.ID), applicationasset.PresignedReferencedAsset{})}, nil
}

func (h *ResourceHandler) ReplaceUploadedResourceAsset(ctx context.Context, request *thriftresource.ReplaceUploadedResourceAssetRequest) (*thriftresource.ReplaceUploadedResourceAssetResponse, error) {
	...
	return &thriftresource.ReplaceUploadedResourceAssetResponse{ResourceAsset: resourceAssetDTO(item, isPrimaryResourceAsset(parent, item.ID), assetItem)}, nil
}

func (h *ResourceHandler) UpdateResourceAsset(ctx context.Context, request *thriftresource.UpdateResourceAssetRequest) (*thriftresource.UpdateResourceAssetResponse, error) {
	...
	return &thriftresource.UpdateResourceAssetResponse{ResourceAsset: resourceAssetDTO(item, isPrimaryResourceAsset(parent, item.ID), assetItem)}, nil
}

func (h *ResourceHandler) SetPrimaryResourceAsset(ctx context.Context, request *thriftresource.SetPrimaryResourceAssetRequest) (*thriftresource.SetPrimaryResourceAssetResponse, error) {
	...
	dto, err := h.resourceDTO(ctx, scope, request.ProjectID, item)
	return &thriftresource.SetPrimaryResourceAssetResponse{Resource: dto}, err
}

func (h *ResourceHandler) DeleteResourceAsset(ctx context.Context, request *thriftresource.DeleteResourceAssetRequest) (*thriftbase.Empty, error) {
...
func (h *ResourceHandler) BatchDeleteResourceAssets(ctx context.Context, request *thriftresource.BatchDeleteResourceAssetsRequest) (*thriftbase.Empty, error) {
...
func (h *ResourceHandler) GetResourceAssetGeneration(ctx context.Context, request *thriftresource.GetResourceAssetGenerationRequest) (*thriftresource.GetResourceAssetGenerationResponse, error) {
	...
	return &thriftresource.GetResourceAssetGenerationResponse{Generation: resourceAssetGenerationDTO(item)}, nil
}

func (h *ResourceHandler) UpdateResourceAssetGeneration(ctx context.Context, request *thriftresource.UpdateResourceAssetGenerationRequest) (*thriftresource.UpdateResourceAssetGenerationResponse, error) {
	...
	return &thriftresource.UpdateResourceAssetGenerationResponse{Generation: resourceAssetGenerationDTO(item)}, nil
}

func (h *ResourceHandler) StartResourceAssetGeneration(ctx context.Context, request *thriftresource.StartResourceAssetGenerationRequest) (*thriftresource.StartResourceAssetGenerationResponse, error) {
	...
	return &thriftresource.StartResourceAssetGenerationResponse{TaskRunID: result.TaskRunID}, nil
}

func (h *ResourceHandler) CancelResourceAssetGeneration(ctx context.Context, request *thriftresource.CancelResourceAssetGenerationRequest) (*thriftbase.Empty, error) {
...
func (h *ResourceHandler) GetResourceAssetGenerationRun(ctx context.Context, request *thriftresource.GetResourceAssetGenerationRunRequest) (*thriftresource.GetResourceAssetGenerationRunResponse, error) {
	...
	return &thriftresource.GetResourceAssetGenerationRunResponse{Run: resourceAssetGenerationRunDTO(item)}, nil
}
...
func baseResourceDTO(item domainresource.Resource) *thriftresource.Resource {
	return &thriftresource.Resource{ResourceID: item.ID, ProjectID: item.OwnerID, Type: thriftresource.ResourceType(item.Type), Name: item.Name, Description: item.Description, ResourceAssetCount: item.ResourceAssetCount, Revision: item.Revision, CreatedBy: item.CreatedBy, CreatedAt: timestamp(item.CreatedAt), UpdatedAt: timestamp(item.UpdatedAt), OwnerType: thriftresource.ResourceOwnerType(item.OwnerType), ApprovedResourceAssetCount: item.ApprovedResourceAssetCount}
}

func (h *ResourceHandler) resourceDTOs(ctx context.Context, scope applicationresource.Scope, projectID string, items []domainresource.Resource) ([]*thriftresource.Resource, error) {
	...
	result := make([]*thriftresource.Resource, 0, len(items))
	for _, item := range items {
		...
		if item.PrimaryResourceAssetID != nil {
			...
			dto.PrimaryResourceAsset = &thriftresource.ResourceAssetSummary{ResourceAssetID: binding.ID, Name: binding.Name, CurrentAssetID: optionalString(binding.CurrentAssetID), PreviewURL: optionalString(current.URL), ExpiresAt: previewExpiresAt(current.URL, current.ExpiresAt), MediaType: thriftasset.AssetMediaType(binding.MediaType), SourceType: thriftresource.ResourceAssetSourceType(binding.SourceType), Reviews: reviewsFromPresigned(current)}
		}
...
func (h *ResourceHandler) resourceDTO(ctx context.Context, scope applicationresource.Scope, projectID string, item domainresource.Resource) (*thriftresource.Resource, error) {
	dto := baseResourceDTO(item)
	if item.PrimaryResourceAssetID == nil {
		return dto, nil
	}
	...
	dto.PrimaryResourceAsset = &thriftresource.ResourceAssetSummary{ResourceAssetID: binding.ID, Name: binding.Name, CurrentAssetID: optionalString(binding.CurrentAssetID), PreviewURL: optionalString(assetItem.URL), ExpiresAt: previewExpiresAt(assetItem.URL, assetItem.ExpiresAt), MediaType: thriftasset.AssetMediaType(binding.MediaType), SourceType: thriftresource.ResourceAssetSourceType(binding.SourceType), Reviews: reviewsFromPresigned(assetItem)}
	return dto, nil
}
func resourceAssetDTOs(items []domainresource.ResourceAsset, primaryID *string, assets map[string]applicationasset.PresignedReferencedAsset) []*thriftresource.ResourceAsset {
	result := make([]*thriftresource.ResourceAsset, 0, len(items))
	for _, item := range items {
...
func resourceAssetDTO(item domainresource.ResourceAsset, isPrimary bool, current applicationasset.PresignedReferencedAsset) *thriftresource.ResourceAsset {
	return &thriftresource.ResourceAsset{ResourceAssetID: item.ID, ResourceID: item.ResourceID, Name: item.Name, SequenceNo: item.SequenceNo, CurrentAssetID: optionalString(item.CurrentAssetID), IsPrimary: isPrimary, Revision: item.Revision, CreatedAt: timestamp(item.CreatedAt), UpdatedAt: timestamp(item.UpdatedAt), PreviewURL: optionalString(current.URL), ExpiresAt: previewExpiresAt(current.URL, current.ExpiresAt), MediaType: thriftasset.AssetMediaType(item.MediaType), SourceType: thriftresource.ResourceAssetSourceType(item.SourceType), Reviews: reviewsFromPresigned(current)}
}

func reviewsFromPresigned(current applicationasset.PresignedReferencedAsset) []*thriftasset.AssetReview {
	return assetReviewDTOs(current.Asset.Reviews)
}

func resourceAssetGenerationDTO(item applicationresourceassetgeneration.Generation) *thriftresource.ResourceAssetGeneration {
	uploaded := make([]*thriftresource.ResourceAssetGenerationUploadedReference, 0, len(item.UploadedReferences))
	for _, reference := range item.UploadedReferences {
		uploaded = append(uploaded, &thriftresource.ResourceAssetGenerationUploadedReference{AssetID: reference.AssetID, FileName: reference.FileName, PreviewURL: optionalString(reference.PreviewURL)})
	}
	resources := make([]*thriftresource.ResourceAssetGenerationResourceReference, 0, len(item.ResourceReferences))
	for _, reference := range item.ResourceReferences {
		resources = append(resources, &thriftresource.ResourceAssetGenerationResourceReference{ResourceID: reference.ResourceID, SequenceNo: reference.SequenceNo})
	}
	result := &thriftresource.ResourceAssetGeneration{
...
func resourceAssetGenerationStateDTO(item applicationresourceassetgeneration.GenerationState) *thriftresource.ResourceAssetGenerationState {
	return &thriftresource.ResourceAssetGenerationState{ResourceAssetID: item.ResourceAssetID, TaskRunID: item.Run.TaskRunID, Status: resourceAssetGenerationRunStatusDTO(item.Run.Status), ErrorCode: optionalString(item.Run.ErrorCode), ErrorMessage: optionalString(item.Run.ErrorMessage)}
}

func resourceAssetGenerationPatch(patch *thriftresource.ResourceAssetGenerationPatch) (applicationresourceassetgeneration.GenerationPatch, error) {
...
func resourceAssetGenerationRunDTO(item applicationresourceassetgeneration.Run) *thriftresource.ResourceAssetGenerationRun {
	inputs := make([]*thriftresource.ResourceAssetGenerationRunInput, 0, len(item.Inputs))
	for _, input := range item.Inputs {
		inputs = append(inputs, &thriftresource.ResourceAssetGenerationRunInput{Position: input.Position, SourceType: resourceAssetGenerationInputSourceDTO(input.SourceType), AssetID: input.AssetID})
	}
	...
	result := &thriftresource.ResourceAssetGenerationRun{
...
func resourceAssetGenerationResolution(value thriftresource.ResourceAssetGenerationResolution) domainimagegeneration.Resolution {
	switch value {
	case thriftresource.ResourceAssetGenerationResolution_RESOLUTION_480P:
		return domainimagegeneration.Resolution480P
	case thriftresource.ResourceAssetGenerationResolution_RESOLUTION_720P:
		return domainimagegeneration.Resolution720P
	case thriftresource.ResourceAssetGenerationResolution_RESOLUTION_1080P:
		return domainimagegeneration.Resolution1080P
	case thriftresource.ResourceAssetGenerationResolution_RESOLUTION_2K:
		return domainimagegeneration.Resolution2K
	case thriftresource.ResourceAssetGenerationResolution_RESOLUTION_4K:
...
func resourceAssetGenerationResolutionDTO(value domainimagegeneration.Resolution) *thriftresource.ResourceAssetGenerationResolution {
	var result thriftresource.ResourceAssetGenerationResolution
	switch value {
	case domainimagegeneration.Resolution480P:
		result = thriftresource.ResourceAssetGenerationResolution_RESOLUTION_480P
	case domainimagegeneration.Resolution720P:
		result = thriftresource.ResourceAssetGenerationResolution_RESOLUTION_720P
	case domainimagegeneration.Resolution1080P:
		result = thriftresource.ResourceAssetGenerationResolution_RESOLUTION_1080P
	case domainimagegeneration.Resolution2K:
		result = thriftresource.ResourceAssetGenerationResolution_RESOLUTION_2K
	case domainimagegeneration.Resolution4K:
		result = thriftresource.ResourceAssetGenerationResolution_RESOLUTION_4K
	default:
		return nil
	}
	return &result
...
func resourceAssetGenerationAspectRatio(value thriftresource.ResourceAssetGenerationAspectRatio) domainimagegeneration.AspectRatio {
	switch value {
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_1_1:
		return domainimagegeneration.AspectRatio1x1
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_3_4:
		return domainimagegeneration.AspectRatio3x4
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_4_3:
		return domainimagegeneration.AspectRatio4x3
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_9_16:
		return domainimagegeneration.AspectRatio9x16
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_16_9:
		return domainimagegeneration.AspectRatio16x9
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_3_2:
		return domainimagegeneration.AspectRatio3x2
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_2_3:
		return domainimagegeneration.AspectRatio2x3
	case thriftresource.ResourceAssetGenerationAspectRatio_RATIO_21_9:
...
func resourceAssetGenerationAspectRatioDTO(value domainimagegeneration.AspectRatio) *thriftresource.ResourceAssetGenerationAspectRatio {
	var result thriftresource.ResourceAssetGenerationAspectRatio
	switch value {
	case domainimagegeneration.AspectRatio1x1:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_1_1
	case domainimagegeneration.AspectRatio3x4:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_3_4
	case domainimagegeneration.AspectRatio4x3:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_4_3
	case domainimagegeneration.AspectRatio9x16:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_9_16
	case domainimagegeneration.AspectRatio16x9:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_16_9
	case domainimagegeneration.AspectRatio3x2:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_3_2
	case domainimagegeneration.AspectRatio2x3:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_2_3
	case domainimagegeneration.AspectRatio21x9:
		result = thriftresource.ResourceAssetGenerationAspectRatio_RATIO_21_9
	default:
		return nil
	}
	return &result
...
func resourceAssetGenerationRunStatusDTO(value domaintask.Status) thriftresource.ResourceAssetGenerationRunStatus {
	switch value {
	case domaintask.StatusQueued:
		return thriftresource.ResourceAssetGenerationRunStatus_QUEUED
	case domaintask.StatusRunning:
		return thriftresource.ResourceAssetGenerationRunStatus_RUNNING
	case domaintask.StatusSucceeded:
		return thriftresource.ResourceAssetGenerationRunStatus_SUCCEEDED
	case domaintask.StatusFailed:
		return thriftresource.ResourceAssetGenerationRunStatus_FAILED
	case domaintask.StatusCancelled:
		return thriftresource.ResourceAssetGenerationRunStatus_CANCELLED
	default:
		return 0
	}
}

func resourceAssetGenerationInputSourceDTO(value applicationresourceassetgeneration.RunInputSource) thriftresource.ResourceAssetGenerationInputSourceType {
	if value == applicationresourceassetgeneration.RunInputUploaded {
		return thriftresource.ResourceAssetGenerationInputSourceType_UPLOADED
	}
	if value == applicationresourceassetgeneration.RunInputResource {
		return thriftresource.ResourceAssetGenerationInputSourceType_RESOURCE_ASSET
	}
	return 0
}

func optionalTimestamp(value *time.Time) *thriftcommon.Timestamp {
	if value == nil {
		return nil
	}
...
func resourceTypePointer(value *thriftresource.ResourceType) *domainresource.Type {
	if value == nil {
		return nil
	}
...
func resourceSort(sort *thriftresource.ResourceSort) (applicationresource.SortField, applicationresource.SortDirection, error) {
	if sort == nil {
	...
	if sort.IsSetField() {
		...
		case thriftresource.ResourceSortField_CREATED_AT:
			field = applicationresource.SortCreatedAt
		case thriftresource.ResourceSortField_UPDATED_AT:
