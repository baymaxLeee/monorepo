...
import (
	...
	thriftprojectusage "github.com/example/monorepo/canvas/internal/api/contracts/projectusage"
...
func (handler *ProjectUsageHandler) DownloadProjectUsageXLSX(
	ctx context.Context,
	request *thriftprojectusage.DownloadProjectUsageXLSXRequest,
) (*thriftprojectusage.DownloadProjectUsageXLSXResponse, error) {
	...
	return &thriftprojectusage.DownloadProjectUsageXLSXResponse{
