...
import { createMemoryCandidate, listActiveMemories } from "../../persistence/repository.js";
...
async function createMemory(input: MemoryInput, { context }: { context: ToolContext }) {
  try {
