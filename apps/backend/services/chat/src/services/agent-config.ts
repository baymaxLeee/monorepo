...
export const ARTIFACT_PART_CONTENT_MAX_CHARS = 100_000;

export const ARTIFACT_CHUNKED_REVISION_THRESHOLD = 200_000;
export const ARTIFACT_REVISION_CHUNK_CHARS = 100_000;
