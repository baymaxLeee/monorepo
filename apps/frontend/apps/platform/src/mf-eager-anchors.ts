 ...
 * the host so they are bundled into platform's initial chunk and registered into
 ...
 * statically reaches it**. platform currently has no business need to import
 ...
 *
 * Side-effect imports below force these packages into platform's main bundle.
 ...
 *   3. Add it to platform's package.json deps if not already there.
 *   4. Restart `just dev`.
 */

// Side-effect imports — these force the workspace packages into platform's bundle
