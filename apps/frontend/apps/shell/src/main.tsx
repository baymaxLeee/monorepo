...
//   1. shell's rspack.config marks platform shared deps `eager: true`,
...
//
// (mfe-bot, the remote, still uses an async boundary in its main.tsx because
...
// Pulls @app/* workspace packages into shell's bundle so the `eager: true`
