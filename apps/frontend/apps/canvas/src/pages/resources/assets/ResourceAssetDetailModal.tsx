...
import styles from "./ResourceAssetDetailModal.module.less";

export function ResourceAssetDetailModal({
  asset,
  busy = false,
  children,
  generationFailure,
    ...
    >
      <section className={styles.previewCard}>
        ...
        <div className={styles.actions}>
          ...
          <Button
            disabled={busy || Boolean(generationFailure) || !onSetPrimary || asset.IsPrimary || !asset.CurrentAssetID}
