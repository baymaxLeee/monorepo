...
export function FormTab() {
  ...
  return (
    <DemoCard title="表单控件" description="Input、Select、Checkbox、Switch、Textarea" contentClassName="overflow-auto">
      <div className="flex min-h-full flex-col justify-between gap-6">
        <div className="grid max-w-md gap-5">
          ...
          <div className="flex items-center justify-between rounded-lg border p-3">
            ...
            <Switch id="marketing" checked={marketing} onCheckedChange={(v) => setMarketing(v === true)} />
          </div>
        </div>
        <div>
