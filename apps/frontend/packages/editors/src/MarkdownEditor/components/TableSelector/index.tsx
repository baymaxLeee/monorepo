...
export const TableSelector = ({ onSelect, className }: TableSelectorProps) => {
  ...
  return (
    <div className={cn("min-w-[200px] rounded-lg border bg-popover p-2 shadow-md", className)}>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isActive && "border-blue-500 bg-blue-100 shadow-[0_0_0_1px_var(--color-blue-200)]",
              )}
