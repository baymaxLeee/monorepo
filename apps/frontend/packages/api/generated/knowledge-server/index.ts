 ...
 * Knowledge Service
 * Knowledge base: parsing, virtual agent workspaces, and RAG
...
const ingestIngestPost = (
    createSourceDocumentsInput: CreateSourceDocumentsInput,
 options?: SecondParameter<typeof apiMutator<IngestResult>>,) => {
      return apiMutator<IngestResult>(
      {url: `/ingest`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: createSourceDocumentsInput
    },
      options);
    }
