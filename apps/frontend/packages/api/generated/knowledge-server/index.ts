 ...
 * @summary Put Object
 */
const putObjectInternalObjectsScopePost = (
    scope: string,
 options?: SecondParameter<typeof apiMutator<StoredServiceObject>>,) => {
      return apiMutator<StoredServiceObject>(
      {url: `/internal/objects/${scope}`, method: 'POST'
    },
      options);
    }
