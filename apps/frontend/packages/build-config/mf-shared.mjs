 ...
 *   (UI kit `components` + `@repo/api` stay normal deps so each app tree-shakes them.)
...
const TIER2 = {
  "@repo/shared": { singleton: true, requiredVersion: false },
  "@repo/runtime": { singleton: true, requiredVersion: false },
  "@repo/observability": { singleton: true, requiredVersion: false },
};
