...
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupInput } from "@repo/design-system/shadcn/input-group";
import { cn } from "cn";
...
function ComboboxContent({
  ...
  Pick<ComboboxPrimitive.Positioner.Props, "side" | "align" | "sideOffset" | "alignOffset" | "anchor"> & {
    ...
    positionerStyle?: ComboboxPrimitive.Positioner.Props["style"];
  }) {
  const layerStyle = usePortalLayerStyle<ComboboxPrimitive.Positioner.State>(positionerStyle);
  return (
