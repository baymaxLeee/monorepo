...
import { GLOBAL_TOAST_Z_INDEX } from "./portal-layer";
...
function ToastViewport({ className, style, ...props }: ToastPrimitive.Viewport.Props) {
  return (
    <ToastPrimitive.Viewport
      ...
      style={{ ...style, zIndex: GLOBAL_TOAST_Z_INDEX }}
      className={cn(
        "pointer-events-none fixed top-4 right-0 bottom-auto left-0 mx-auto w-[calc(100vw-2rem)] max-w-sm outline-none",
        className,
      )}
      {...props}
    />
...
function Toast({ className, swipeDirection = "up", ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
