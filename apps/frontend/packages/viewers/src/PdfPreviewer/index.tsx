...
const PdfPreviewer = forwardRef<PdfPreviewerRef, PdfPreviewerProps>(function PdfPreviewer(props, ref) {
  const { width = "100%", height = "100%", style, className, loadingText = "文件解析中..." } = props;
  return (
