...
const XMindPreviewer = forwardRef<XMindPreviewerRef, XMindPreviewerProps>(function XMindPreviewer(props, ref) {
  const { width = "100%", height = "100%", style, className, loadingText = "脑图文件解析中..." } = props;
  return (
    <Lazy<XMindPreviewerProps>
      ...
      fallback={
        <div
          ...
          className={cn("relative min-h-0 overflow-hidden rounded-md border bg-background", className)}
        >
